            ...
            <?php foreach ($posts as $post) : ?>
                <div class="card border-dark bg-dark">
                    <div class="card-body bg-dark">
                        <h5 class="card-header bg-dark border-white"><a class="text-warning" href="<?= Core\HTTP\Url::getUrl() . DS . html_entity_decode($post->category_slug .'/'. $post->slug .'/'. $post->page); ?>"><?= html_entity_decode($post->title); ?></a></h5>
