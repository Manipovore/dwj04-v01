            ...
            <?php for($i = 0; $i < 10 ;$i++ ) : ?>
                <div class="card border-dark bg-dark">
                    <div class="card-body bg-dark">
                        <h5 class="card-header bg-dark border-white"><a class="text-warning" href="<?= html_entity_decode($posts[$i]->category_slug .'/'. $posts[$i]->slug .'/'. $posts[$i]->id); ?>"><?= html_entity_decode($posts[$i]->title); ?></a></h5>
